...
const productTemplate = ({ productId, src, name, category, price, discount }) => {
  //container
  ...
  productLink.href = `/products.html?productId=${productId}`
  ...
  productDescriptionCart.dataset.action = 'add-cart'
  productDescriptionCart.dataset.productName = name
  productDescriptionCart.dataset.productSrc = src
  productDescriptionCart.dataset.productId = productId
  productDescriptionCart.dataset.productCategory = category
  productDescriptionCart.dataset.productPrice = price
  productDescriptionCart.dataset.productDiscount = discount
